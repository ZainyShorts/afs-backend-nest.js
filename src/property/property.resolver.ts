...
export class PropertyResolver {
    ...
    async getProperties(
      ...
      @Args('page', { type: () => String, nullable: true, defaultValue: 1 }) page?: string,
      @Args('limit', { type: () => String, nullable: true, defaultValue: 10 }) limit?: string,
      ...
      return this.propertyService.getProperties(filter, Number(page), Number(limit), sortBy, sortOrder);
    }
